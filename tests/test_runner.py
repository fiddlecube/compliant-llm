...
def test_run_single_test(mock_completion):
    ...
    assert result["test_prompt"] == "Test prompt"
    assert "This is a mocked response" in result["response"]
...
# @patch('core.runner.load_and_validate_config')
# @patch('core.runner.ConfigManager')
